...
namespace ITelligent.Scheduling
{
    class clsN0
    {
        ...
        /// <summary>
        /// Realiza el movimiento N0 para ello se toma uno de lo bloques
        ...
        /// <returns></returns>
        public clsDatosMovimiento SeleccionarYRealizarMovimiento(clsDatosJobShop cData, clsDatosSchedule cSchedule)
        {
