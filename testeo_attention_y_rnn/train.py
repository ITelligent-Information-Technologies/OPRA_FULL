...
"""
    Se realizan pruebas con estos dos algoritmos, uno el de attention ya se habia
    probado con buenso resultados.
"""
parser = argparse.ArgumentParser()

parser.add_argument("--model_type", type=str, default="rnn")
parser.add_argument("--seq_len", type=int, default=30)
parser.add_argument("--num_epochs", type=int, default=30)#original 100
parser.add_argument("--num_tr_dataset", type=int, default=100000)#original 100000
parser.add_argument("--num_te_dataset", type=int, default=2000)#original 2000
...
if __name__ =="__main__":
    ...
    for i, pointset in test_dataset: # Modificado Itelligetn
