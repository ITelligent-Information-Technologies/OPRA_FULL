...
{
    [Serializable]
    class clsDataStructuresRutas
    {
        //public Stopwatch swTotal;
        //public Stopwatch swMedir;
        public Dictionary<string, clsDictionarySorted> dicIdPuntoConsumoIdVehicleSdEdgeCoste = new Dictionary<string, clsDictionarySorted>();
        ...
        public clsDataStructuresRutas(clsDataProblem cProblem)
        {
            ...
            for (Int32 intIdPuntoConsumoOut = 1; intIdPuntoConsumoOut <= cProblem.intPuntosConsumoNumber; intIdPuntoConsumoOut++)
            {
                ...
                for (Int32 intV = 1; intV <= cProblem.intVehiclesNumber; intV++)
                {
                    ...
                    if (!dicIdPuntoConsumoIdVehicleSdEdgeCoste.ContainsKey(intIdPuntoConsumoOut + "_" + intV))
                        dicIdPuntoConsumoIdVehicleSdEdgeCoste.Add(intIdPuntoConsumoOut + "_" + intV, new clsDictionarySorted());
                    dblCoste = dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoOut + "_" + intV].Add(strEdge, dblCoste);
        ...
        public void Deshacer(clsDataProblem cProblem, clsParameters cParameters)
        {
            ...
            for (Int32 intIndex = lstUnDoIdPuntoConsumoDestroyEdge.Count - 1; intIndex >= 0; intIndex--)
            {
                ...
                AddPuntoConsumoToEdge(cProblem, cParameters, intIdPuntoConsumo, strEdge, false, false,false);
                if (!hsIdVehicle.Contains(intIdVehicle))
                    hsIdVehicle.Add(intIdVehicle);
            }         
        }
        ...
        public void AddPuntoConsumoToEdge(clsDataProblem cProblem, clsParameters cParameters, Int32 intIdPuntoConsumo, string strEdge, Boolean blnGuardarDeshacer, Boolean blnCalcularTimeWindowsYHolguras, Boolean blnCalcularNoAsignadosParaRegret)
        {
            ...
            // Va actualizando cada operacion no asignada para despues poder calcular el regret
            if (blnCalcularNoAsignadosParaRegret)
            {
                foreach (Int32 intIdPuntoConsumoOut in hsIdPuntoConsumoNoAsignados)
                {
                    // Debe quitar el edge antiguo strEdge
                    dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoOut + "_" + intIdVehicle].Remove(strEdge);
                    // Calcula el coste al edge anterior
                    AddPuntoConsumoOutAEdge(cProblem, intIdPuntoConsumoOut, intIdPuntoConsumoAnterior + "_" + intIdPuntoConsumo);
                    // Calcula con el edge siguiente
                    AddPuntoConsumoOutAEdge(cProblem, intIdPuntoConsumoOut, intIdPuntoConsumo + "_" + intIdPuntoConsumoSiguiente);
                }
            }
        }

        /// <summary>
        /// Esta funcion recibe un punto de consumo que no esta asignado (puntoconsumoout)
        /// y estima el coste de añadirlo al edge y guarda los datos en
        /// dicIdPuntoConsumoIdVehicleSdEdgeCoste y dicIdPuntoConsumoSdIdVehicleCoste
        /// </summary>
        /// <param name="cProblem"></param>
        /// <param name="intIdPuntoConsumoOut"></param>
        /// <param name="strEdge"></param>
        private void AddPuntoConsumoOutAEdge(clsDataProblem cProblem, Int32 intIdPuntoConsumoOut, string strEdge)
        {
            Int32 intIdVehicle = dicEdgeAIdVehicle[strEdge];
            Int32 intIdPuntoConsumoAnterior = dicEdgeAIdOperacionesAnteriorSiguiente[strEdge].Item1;
            Int32 intIdPuntoConsumoSiguiente = dicEdgeAIdOperacionesAnteriorSiguiente[strEdge].Item2;
            double dblCoste = cProblem.dicIdPuntoAIdPuntoBATiempo[intIdPuntoConsumoAnterior + "_" + intIdPuntoConsumoOut] +
                ...
                cProblem.dicIdPuntoAIdPuntoBATiempo[intIdPuntoConsumoAnterior + "_" + intIdPuntoConsumoSiguiente];
            //Añade el coste a idPuntoConsumo y IdVehicle al Edge
            if (!dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoOut + "_" + intIdVehicle].ExistsKey(strEdge))
                dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoOut + "_" + intIdVehicle].Add(strEdge, dblCoste);
            else
                dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoOut + "_" + intIdVehicle].Update(strEdge, dblCoste);
            // Añade el el menor para ese punto de consumo y ese vehiculo la vehiculo
            if (!dicIdPuntoConsumoSdIdVehicleCoste[intIdPuntoConsumoOut].ExistsKey(intIdVehicle.ToString()))
                dicIdPuntoConsumoSdIdVehicleCoste[intIdPuntoConsumoOut].Add(intIdVehicle.ToString(), dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoOut + "_" + intIdVehicle].GetMinFirstValue(0));
            else
                dicIdPuntoConsumoSdIdVehicleCoste[intIdPuntoConsumoOut].Update(intIdVehicle.ToString(), dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoOut + "_" + intIdVehicle].GetMinFirstValue(0));
        }
        ...
        /// <summary>
        /// Esta funcion recorre cada no insertado y calcula su coste respecto a todos
        /// los insertados y va guardando los valores en las estructuras:
        /// dicIdPuntoConsumoIdVehicleSdEdgeCoste y dicIdPuntoConsumoSdIdVehicleCoste
        /// </summary>
        /// <param name="cProblem"></param>
        public void CalcularCosteInsercionParaTodosLosNoInsertados(clsDataProblem cProblem)
        {
            // Reinicializa los datos
            dicIdPuntoConsumoIdVehicleSdEdgeCoste = new Dictionary<string, clsDictionarySorted>();
            dicIdPuntoConsumoSdIdVehicleCoste = new Dictionary<int, clsDictionarySorted>();
            // Recorre cada vehiculo
            for (Int32 intIdVehicle = 1; intIdVehicle <= cProblem.intVehiclesNumber; intIdVehicle++)
            {
                // Repite para cada no asignado
                foreach (Int32 intIdPuntoConsumoOut in hsIdPuntoConsumoNoAsignados)
                {
                    ...
                    Int32 intIdPuntoConsumoAnterior = intIdPuntoConsumoInicio;
                    Int32 intIdPuntoConsumoSiguiente = dicIdPuntoConsumoAIdSiguiente[intIdPuntoConsumoAnterior];
                    string strEdge = intIdPuntoConsumoAnterior + "_" + intIdPuntoConsumoSiguiente;
                    // Repite para todos los edges de un vehiculo
                    ...
                    while (blnEnBucle)
                    {
                        ...
                        if (!dicIdPuntoConsumoIdVehicleSdEdgeCoste.ContainsKey(intIdPuntoConsumoOut + "_" + intIdVehicle))
                            dicIdPuntoConsumoIdVehicleSdEdgeCoste.Add(intIdPuntoConsumoOut + "_" + intIdVehicle, new clsDictionarySorted());
                        dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoOut + "_" + intIdVehicle].Add(strEdge, dblCoste);
                        // Va moviendo al punto de consumo siguiente
                        intIdPuntoConsumoAnterior = intIdPuntoConsumoSiguiente;
                        // Si ha llegado al final sale
                        if (intIdPuntoConsumoAnterior == intIdPuntoConsumoFin)
                            blnEnBucle = false;
                        else // Va moviendo al punto de consumo siguiente
                        {
                            intIdPuntoConsumoSiguiente = dicIdPuntoConsumoAIdSiguiente[intIdPuntoConsumoAnterior];
                            strEdge = intIdPuntoConsumoAnterior + "_" + intIdPuntoConsumoSiguiente;
                        }
                    }// Fin blnEnBucle
                    if (!dicIdPuntoConsumoSdIdVehicleCoste.ContainsKey(intIdPuntoConsumoOut))
                        dicIdPuntoConsumoSdIdVehicleCoste.Add(intIdPuntoConsumoOut, new clsDictionarySorted());
                    if (dicIdPuntoConsumoSdIdVehicleCoste[intIdPuntoConsumoOut].ExistsKey(intIdVehicle.ToString()))
                        ...
                        dicIdPuntoConsumoSdIdVehicleCoste[intIdPuntoConsumoOut].Add(intIdVehicle.ToString(), dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoOut + "_" + intIdVehicle].GetMinFirstValue(0));
                }// fin foreach no asignado
            }// fin for intIdVehicle
        }
        ...
        public (Int32, string) GetIdPuntoConsumoYEdgeDeMinRegret(clsDataProblem cProblem, clsParameters cParameters, Int32 intRegretLevel)
        {
            ...
            Int32 intIdVehicleMax = 0;
            Int32 intIdVehicleMin = 0;
            foreach (Int32 intIdPuntoConsumoNoAsignado in hsIdPuntoConsumoNoAsignados)
            {
                ...
                double dblCoste = 0;
                double dblCoste1 = 0;
                Int32 intIdVehicle1 = 0;
                dblCoste1 = dicIdPuntoConsumoSdIdVehicleCoste[intIdPuntoConsumoNoAsignado].GetMinFirstValue(intIndice1);
                intIdVehicle1 = Convert.ToInt32(dicIdPuntoConsumoSdIdVehicleCoste[intIdPuntoConsumoNoAsignado].GetMinFirstKey(intIndice1));
                if (intRegretLevel == 1)
                {
                }
                ...
                if (dblCoste > dblCosteMax && intRegretLevel > 1)
                {
                    ...
                    dblCoste1Min = dblCoste1;
                    intIdVehicleMax = intIdVehicle1;
                }
            }
            // Obtiene el edge al que pertenece            
            if (intRegretLevel == 1)
            {
                string strEdgeMin = dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoMin + "_" + intIdVehicleMin].GetKey(dblCoste1Min);
                return (intIdPuntoConsumoMin, strEdgeMin);
            }
            string strEdgeMax = dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumoMax + "_" + intIdVehicleMax].GetKey(dblCoste1Min);
        ...
        public (Int32, string) GetIdPuntoConsumoYEdgeDeMinRegretConRestricciones(clsDataProblem cProblem, clsParameters cParameters, Int32 intRegretLevel)
        {
            ...
            foreach (Int32 intIdPuntoConsumoNoAsignado in hsIdPuntoConsumoNoAsignados)
            {
                ...
                SortedDictionary<double, Tuple<Int32, string>> sdRegret = ObtenerCostesValidosParaPuntoConsumo(cProblem, cParameters, intIdPuntoConsumoNoAsignado, intRegretLevel);
                ...
                if (sdRegret.Count > 0)
                {
                    ...
                    // Calcula el regret
                    if (sdRegret.Count > 0)
                        dblCoste1 = sdRegret.ElementAt(0).Key;
                    if (sdRegret.Count > 1)
                        dblCoste2 = sdRegret.ElementAt(1).Key;
                    if (sdRegret.Count > 2)
                        dblCoste3 = sdRegret.ElementAt(2).Key;
                    ...
                    if (dblCoste < dblMinCoste && intRegretLevel == 1)
                    {
                        ...
                        dblCoste1Min = dblCoste1;
                        strEdgeMin = sdRegret.ElementAt(0).Value.Item2;
                    }
                    if (dblCoste > dblMaxCoste && intRegretLevel > 1)
                    {
                        ...
                        dblCoste1Min = dblCoste1;
                        strEdgeMax = sdRegret.ElementAt(0).Value.Item2;
                    }
                }
            }
        ...
        /// <param name="intIdPuntoConsumo"></param>
        /// <returns></returns>
        private SortedDictionary<double, Tuple<Int32, string>> ObtenerCostesValidosParaPuntoConsumo(clsDataProblem cProblem, clsParameters clsParameters, Int32 intIdPuntoConsumo, Int32 intRegretLevel)
        {
            SortedDictionary<double, Tuple<Int32, string>> sdResultados = new SortedDictionary<double, Tuple<int, string>>();// dblCoste, intIdVehicle, strEdge
            Boolean blnEnBucle = true;
            HashSet<Int32> hsVehicleProcesado = new HashSet<int>();
            Int32 intCuenta = dicIdPuntoConsumoSdIdVehicleCoste.Count();
            HashSet<Int32> hsIdVehicles = new HashSet<int>();
            // Se queda solo con los vehiculos validos
            for (Int32 intIdVehicle = 1; intIdVehicle <= cProblem.intVehiclesNumber && blnEnBucle; intIdVehicle++)
            {
                if (dicIdPuntoConsumoSdIdVehicleCoste.ContainsKey(intIdPuntoConsumo) && dicIdPuntoConsumoSdIdVehicleCoste[intIdPuntoConsumo].ExistsKey(intIdVehicle.ToString()))
                    hsIdVehicles.Add(intIdVehicle);
            }
            // Va procesando todo el bucle
            Int32 intIndex = 0;
            HashSet<Int32> hsBorrar = new HashSet<int>();
            double dblCosteInsertar = double.MaxValue;
            // Entra en el bucle mientras falte por recorrer
            while (blnEnBucle)
            {
                foreach (Int32 intIdVehicle in hsIdVehicles)
                {
                    // Si no hay mas datos para este vehiculo
                    if (intIndex >= dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumo + "_" + intIdVehicle].Count())
                    {
                        hsBorrar.Add(intIdVehicle);
                    }
                    else // Hay mas datos para este vehiculo
                    {
                        string strEdge = dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumo + "_" + intIdVehicle].GetMinFirstKey(intIndex);
                        dblCosteInsertar = dicIdPuntoConsumoIdVehicleSdEdgeCoste[intIdPuntoConsumo + "_" + intIdVehicle].GetMinFirstValue(intIndex);
                        // Chequea si que el coste a insertar es menor que la holgura maxima
                        if (dicIdVehicleHolguraMax[intIdVehicle] >= dblCosteInsertar)
                        {
                            // Comprueba si el vehiculo es apto para el puntoconsumo
                            if (!hsVehicleProcesado.Contains(intIdVehicle) && cProblem.dicIdPuntoConsumoADatosPuntoConsumo[intIdPuntoConsumo].blnVehiculosAptos[intIdVehicle])
                            {
                                // Comprueba si cumple por capacidad
                                if ((cProblem.dicIdPuntoConsumoADatosPuntoConsumo[intIdPuntoConsumo].dblDemand + dicIdVehicleCapacidadUsada[intIdVehicle]) <= cProblem.dicIdVehicleCapacity[intIdVehicle])
                                {
                                    ...
                                    if (cProblem.dicIdPuntoConsumoADatosPuntoConsumo[intIdPuntoConsumo].dblTimeWindowsMax >= (dicIdPuntoConsumoTiempoFin[intIdPuntoConsumoAnterior] + cProblem.dicIdPuntoAIdPuntoBATiempo[intIdPuntoConsumoAnterior + "_" + intIdPuntoConsumo]))
                                    {
                                        ...
                                        {
                                            while (sdResultados.ContainsKey(dblCosteInsertar))
                                            {
                                                dblCosteInsertar = dblCosteInsertar + 0.00000000001;
                                            }
                                            sdResultados.Add(dblCosteInsertar, new Tuple<Int32, string>(intIdVehicle, strEdge));
                                            hsBorrar.Add(intIdVehicle);
                                            hsVehicleProcesado.Add(intIdVehicle);
                                        }
                                    }
                                }
                            }
                    ...
                    // Si el vehiculo actual no ha sido borrado quiere decir que todavia puede ser necesario mirarlo
                    if (!hsBorrar.Contains(intIdVehicle))
                    {
                        // Si ya se han encotrado suficientes para el regret
                        if (sdResultados.Count >= intRegretLevel)
                        {
                            // Si el coste del vehiculo actual es superior al minimo del regret no hay que mirar mas este vehiculo
                            if (dblCosteInsertar >= sdResultados.ElementAt(intRegretLevel - 1).Key)
                                hsBorrar.Add(intIdVehicle);
                        }
                    }
                } // fin foreach intIdVehicle

                // Elimina los que hay que borrar
                foreach (Int32 intIdVehicleBorrar in hsBorrar)
                    hsIdVehicles.Remove(intIdVehicleBorrar);
                // Si no quedan mas vehiculos sale
                if (hsIdVehicles.Count == 0)
                    blnEnBucle = false;
                hsBorrar = new HashSet<int>();
                // Mueve el index al siguiente
                intIndex++;
            } // Bucle while
            return sdResultados;
        }
        ...
        //private void ObtenerMenorCosteParaPuntoConsumoYVehiculo2(Int32 intIdPuntoConsumoOut, Int32 intIdVehicle)
        //{
        ...
        /// <param name="intIdPuntoConsumoOut"></param>
        /// <param name="strEdge"></param>
        //private void ObtenerCosteInsercionParaPuntoConsumoYEdge2(clsDataProblem cProblem, Int32 intIdPuntoConsumoOut, string strEdge)
        //{
        //    Int32 intIdPuntoConsumoAnterior = dicEdgeAIdOperacionesAnteriorSiguiente[strEdge].Item1;
        //    Int32 intIdPuntoConsumoSiguiente = dicEdgeAIdOperacionesAnteriorSiguiente[strEdge].Item2;
        //    Int32 intIdVehicle = dicEdgeAIdVehicle[strEdge];
        ...
        //    private void EliminarCosteInsercionParaPuntoConsumoYEdge2(clsDataProblem cProblem, Int32 intIdPuntoConsumoOut, Int32 intIdPuntoConsumoAnterior, Int32 intIdPuntoConsumoSiguiente, Int32 intIdVehicle)
        //    {
