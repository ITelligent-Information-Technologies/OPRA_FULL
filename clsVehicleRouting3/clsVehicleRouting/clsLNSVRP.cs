...
namespace clsVehicleRouting
{
    class clsLNSVRP
    {
        ...
        {
            clsBackTrackNew cBackTrack = new clsBackTrackNew(cParameters.intNumSolucionesBacktrack);
        ...
        private void LNSVRP(Int32 intHilo, Int32 intHilosParalelos, clsDataProblem cProblem, clsParameters cParameters, clsParametersSimulatedAnnealing cParametersSimulatedAnnealing, clsBackTrackNew cBackTrack)
        {
        ...
        private void DestroyRandom(clsDataProblem cProblem, clsParameters cParameters, clsDataStructuresRutas cRutas, Int32 intNumeroADestruir)
        {
            ...
            cRutas.CalcularCosteInsercionParaTodosLosNoInsertados(cProblem);
        }
        ...
        private void DestroyCritical(clsDataProblem cProblem, clsParameters cParameters, clsDataStructuresRutas cRutas, double dblRandomnessLevel, Int32 intNumeroADestruir)
        {
            ...
            Boolean blnEnBucle = true;
            Int32 intTotalCritical = cRutas.sdCritical.Count();
            Int32 intCuenta = 0;
            while(blnEnBucle)
            {
                if (intCuenta < intTotalCritical && intCuenta<intNumeroADestruir )
                {
                    Int32 intIdPuntoConsumo = Convert.ToInt32(cRutas.sdCritical.GetMinFirstKey(0));
        ...
        private void Repair(clsDataProblem cProblem, clsParameters cParameters, clsDataStructuresRutas cRutas, Int32 intRegretLevel)
        {
            ...
            while (blnEnBucle)
            {
                ...
                cRutas.AddPuntoConsumoToEdge(cProblem, cParameters, valores.Item1, valores.Item2, true, true,true);
        ...
        private clsDataStructuresRutas SolucionInicial(clsDataProblem cProblem, clsParameters cParameters)
        {
            ...
            // Recalcula los tiempos de los no asignados a los edges de las rutas para todos los vehiculos
            cRutas.CalcularCosteInsercionParaTodosLosNoInsertados(cProblem);            // Repara la solucion actual si no hay restricciones
            if (!cParameters.blnConsiderarTimeWindowSuperior)
