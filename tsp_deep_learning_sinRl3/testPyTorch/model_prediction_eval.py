...
strFilePath='D:\\PytorchEnVisualStudio\\pyTorchTSP\\TSP_problem_data_concorde_joshi\\modelC_20_35.txt'
num_cities=20
batch_size=1
beam_size=10
...
cuenta=0
strFilePath='D:\\PytorchEnVisualStudio\\pyTorchTSP\\TSP_problem_data_concorde_joshi\\data_rnd_20_test.csv'
...
for x_batch, y_batch, coordenadas in dataloader:
    ...
    # test beam search
    min_distance, min_solution=bsearch.beam_search(mprobability,mdistance, beam_size)
    ...
    optimal_distance, optimal_solution=calcular_coste_min(moptimal, mdistance)
    # the dataset "lives" in the CPU, so do our mini-batches
    #print()
    #print(connections)
    dif=min_distance/optimal_distance -1
    #print(dif*100)
    dif_total=dif_total+dif
    cuenta_dif=cuenta_dif+1
    print((dif_total/cuenta_dif)*100)
    

print(dif_total/cuenta_dif)
